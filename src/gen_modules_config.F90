...
module g_config
  ...
  integer                :: cpl_stride=1        ! call the ocean<->sea-ice YAC exchange every cpl_stride steps
                                                ! (1 = every step). The fields are registered with dt*cpl_stride;
                                                ! coupling_period in coupling.yaml must match.
