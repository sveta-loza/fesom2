!=============================================================================!
!                   FESIM/FESOM2 Enhanced Profiler Module
!=============================================================================!
...
module fesim_profiler
    ...
    ! Public interface
    public :: fesim_profiler_init, fesim_profiler_finalize
    public :: fesim_profiler_start, fesim_profiler_end
    public :: fesim_profiler_report, fesim_profiler_reset
    public :: fesim_profiler_enabled, fesim_profiler_set_timesteps
    public :: fesim_profiler_set_timestep_size
...
contains
    ...
    !=========================================================================
    subroutine fesim_profiler_init(enable_profiling)
    ...
    end subroutine fesim_profiler_init

    !=========================================================================
    ! Check if profiler is enabled
    !=========================================================================
    function fesim_profiler_enabled() result(enabled)
        logical :: enabled
        enabled = profiler_enabled .and. profiler_initialized
    end function fesim_profiler_enabled

    !=========================================================================
    ! Set total timesteps for reporting
    !=========================================================================
    subroutine fesim_profiler_set_timesteps(timesteps)
        integer, intent(in) :: timesteps
        if (.not. fesim_profiler_enabled()) return
        total_timesteps = timesteps
    end subroutine fesim_profiler_set_timesteps

    !=========================================================================
    ! Set timestep size in seconds for SYPD calculation
    !=========================================================================
    subroutine fesim_profiler_set_timestep_size(dt_seconds)
        real(kind=PROF_WP), intent(in) :: dt_seconds
        if (.not. fesim_profiler_enabled()) return
        timestep_size = dt_seconds
    end subroutine fesim_profiler_set_timestep_size

    !=========================================================================
    ! Start profiling a section
    !=========================================================================
    subroutine fesim_profiler_start(section_name, source_file, line_number)
    ...
    end subroutine fesim_profiler_start

    !=========================================================================
    ! End profiling a section
    !=========================================================================
    subroutine fesim_profiler_end(section_name, source_file, line_number)
        character(len=*), intent(in) :: section_name
        character(len=*), intent(in), optional :: source_file
        integer, intent(in), optional :: line_number
        integer :: profile_index
    ...
    end subroutine fesim_profiler_end

    !=========================================================================
    ! Generate comprehensive profiling report
    !=========================================================================
    subroutine fesim_profiler_report(mpi_comm, mpi_rank, output_unit)
    ...
    end subroutine fesim_profiler_report
    ...
    !=========================================================================
    subroutine fesim_profiler_finalize(mpi_comm, mpi_rank)
        integer, intent(in) :: mpi_comm, mpi_rank
        
        if (.not. fesim_profiler_enabled()) return
        
        call fesim_profiler_report(mpi_comm, mpi_rank)
        profiler_initialized = .false.
    end subroutine fesim_profiler_finalize

    !=========================================================================
    ! Reset all profiling data
    !=========================================================================
    subroutine fesim_profiler_reset()
        integer :: i
        ...
        call_stack_depth = 0
    end subroutine fesim_profiler_reset
